/*! Cover Photo - v0.1.0 - 2016-05-20
* https://github.com/sandropadin/coverphoto
* Copyright (c) 2016 Sandro Padin; Licensed MIT */
  ...
  (function($) {
    ...
    CoverPhoto = (function() {
      ...
      function CoverPhoto(_arg) {
        ...
        this.handlerRemoveActions = __bind(this.handlerRemoveActions, this);

        this.handlerAddActions = __bind(this.handlerAddActions, this);
      ...
      CoverPhoto.prototype.bindEvents = function() {
        ...
        this.on("addActions", this.handlerAddActions);
        this.on("removeActions", this.handlerRemoveActions);
      ...
      CoverPhoto.prototype.handlerAddActions = function() {
        return this.addActions();
      };

      CoverPhoto.prototype.handlerRemoveActions = function() {
        return this.actionsContainer.remove();
      };
      ...
      CoverPhoto.prototype.saveEdit = function(event) {
        var dataUrl;
      ...
      CoverPhoto.prototype.cancelEdit = function(event) {
        event.preventDefault();
